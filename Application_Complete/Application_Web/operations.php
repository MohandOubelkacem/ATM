...
<html>
	...
	<body>
            ...
            <header class="page-header">
                   <h1>Banque<sub>pro</sub><a href="deconnection.php"><button type="button" class="btn btn-secondary">Deconnexion</button></a></h1>
            </header>
...
// PDO: extension orientée objet , classe de php (php data object) qui permet le contenu d'une base de donnée 
    ...
    $requete = $bdd-> query ("SELECT * FROM operation");
...
<table class="table table-hover">
  ...
  <tbody>
     <tr>
      ...
      <td><?php echo $resultat['action_oprt']; ?></td>
      <td><?php echo $resultat['date_oprt'] ?></td>
    </tr>
   <?php 
     }
    ?>
